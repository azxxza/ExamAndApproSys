	...
	function initBasicGrid() {
		jQuery('#basicGrid_div').datagrid({
			...
			columns : [ [
					...
					{
						field : 'interCollegeLeaderApproval',
						title : '分管外事校领导',
						align : 'center',
						formatter : formatResult,
						styler : cellStyler,
	...
	<div id="win" class="easyui-dialog" title="审批意见"
		...
		data-options="modal:true,closed:true">
			...
			<table style="margin-left: 30px; font-size: 9px; margin-top: 20px;" >
				<tr>
					<td>审批意见:</td>
					<td style="padding-left: 15px;"><input  name="description" id="description" class="easyui-textbox" data-options="multiline:true"  style="width: 220px; height: 100px;" ></td>
